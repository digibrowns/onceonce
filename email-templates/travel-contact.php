...
<?php 
  if(isset($_POST['email'])){
	...
	$receiver="hello@onceoncehq.com";
	$subject="Once Once Contacto";
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='http://www.onceoncehq.com/images/logo-mail.png' ></td>
	</tr>
	<tr>
